        	...
        	<main>
				<section className="info-container">
					<article className="info-text" title="Über mich">
						...
						<p>Ein gutes digitales Produkt hat mehrere Aspekte in sich, die gut zusammen harmonieren — Inhalte, Bilder, Farben und Schriften. Es ist intuitiv und einfach zu bedienen, ist unsichtbar und trotzdem da.</p>
