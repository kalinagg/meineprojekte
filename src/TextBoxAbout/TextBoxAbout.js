        	...
        	<main>
				<section className="info-container">
					<article className="info-text" title="Über mich">
						...
						<p>In 2008 bin ich nach Deutschland umgezogen, bin Richtung Frontend Entwicklung gegangen und mich technologisch noch weiter entwickelt. Mit Technologien wie SCSS, Javascript, Typescript, React, Angular, Bootstrap, Material UI und Jest bin ich heute sehr gut vertraut.</p>
